...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheSmsWorksApi.OTPVerifyResponse();
  });
  ...
  describe('OTPVerifyResponse', function() {
    it('should create an instance of OTPVerifyResponse', function() {
      // uncomment below and update the code to test OTPVerifyResponse
      //var instance = new TheSmsWorksApi.OTPVerifyResponse();
      //expect(instance).to.be.a(TheSmsWorksApi.OTPVerifyResponse);
    });
