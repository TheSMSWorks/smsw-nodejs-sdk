...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheSmsWorksApi.AuthApi();
  });
  ...
  describe('AuthApi', function() {
    describe('keySecret', function() {
      it('should call keySecret successfully', function(done) {
        //uncomment below and update the code to test keySecret
        //instance.keySecret(function(error) {
