...
import ExtendedErrorModelAllOf from './model/ExtendedErrorModelAllOf';
...
/**
* The SMS Works provides a low-cost, reliable SMS API for developers. Pay only for delivered texts, all failed messages are refunded..<br>
...
export {
    ...
    /**
     * The ExtendedErrorModelAllOf model constructor.
     * @property {module:model/ExtendedErrorModelAllOf}
     */
